    ...
    <div class="modal-dialog modal-xl">
        <div id="contenedor" class="row_p">
            ...
            <div id="verde" class="content_pagos"> 
                ...
                <hr class="style3">   
                <h5 style="color: black">Primero se envía la cotización al cliente, luego de ello el cliente envía la orden de compra por medio de nuestro correo y a las 12 horas 
                ...
                <div id="contenedor" class="row_p">
                    ...
                    <div id="verde" class="content_pagos"> 
                        ...
                        <button type="button" class="btnwssp btn btn-outline-success btn-lg">
                            <a target="none" href="https://wa.me/527713381978?text=Hola%2CEstoy+interesad%40+en+la+oferta%3A+{{$oferta->titulo}}">
                               Preguntar
                            </a>
                        </button> 
                    </div>
